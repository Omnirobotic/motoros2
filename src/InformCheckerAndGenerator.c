...
#define MAX_JOB_NAME_LENGTH_WITH_EXTENSION \
    (MAX_JOB_NAME_LEN + 4 + 1) // 32 characters for the name, plus 4 for extension, plus terminating null
...
void Ros_InformChecker_CreateJob()
{
    ...
    {
        // COMOLI
        // mpSetAlarm(ALARM_INFORM_JOB_FAIL, APPLICATION_NAME " failed to generate job",
    ...
    // COMOLI
    ok = FileUtilityFunctions_WriteLine(
            fd,
            "///DATE 2013/03/29 05:32"); //"///DATE %d/%02d/%02d %02d:%02d", calendar.usYear, calendar.usMonth,
                                         // calendar.usDay, calendar.usHour, calendar.usMin);
...
//                 groupCombinations[groupCombinationIndex][groupSubNum] = (MP_GRP_ID_TYPE)((atoi(splitComma.data[i] +
//                 2) - 1) + offset); groupSubNum += 1;
//             }
//         }
//     }
...
void Ros_InformChecker_ValidateJob()
{
    ...
    else
    {
        ...
        //     if (fdJob < 0)
        //         mpSetAlarm(ALARM_INFORM_JOB_FAIL, APPLICATION_NAME " failed to validate job",
        ...
        //         mpSetAlarm(ALARM_INFORM_JOB_FAIL, "Invalid " APPLICATION_NAME " job detected",
        ...
        // }
        // else
        //     printf("Skipping validation of robot job '%s'. allow_custom_inform_job is true",
        //     g_nodeConfigSettings.inform_job_name);
    }
}
