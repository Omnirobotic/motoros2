...
const char* const Ros_ErrorHandling_MotionNotReadyCode_ToString(MotionNotReadyCode code)
{
    ...
    switch (code)
    {
    case MOTION_READY: return "motoros2_interfaces__msg__MotionReadyEnum__READY_STR";
    case MOTION_NOT_READY_UNSPECIFIED: return "motoros2_interfaces__msg__MotionReadyEnum__NOT_READY_UNSPECIFIED_STR";
    case MOTION_NOT_READY_ALARM: return "motoros2_interfaces__msg__MotionReadyEnum__NOT_READY_ALARM_STR";
    case MOTION_NOT_READY_ERROR: return "motoros2_interfaces__msg__MotionReadyEnum__NOT_READY_ERROR_STR";
    case MOTION_NOT_READY_ESTOP: return "motoros2_interfaces__msg__MotionReadyEnum__NOT_READY_ESTOP_STR";
    ...
    case MOTION_NOT_READY_NOT_REMOTE: return "motoros2_interfaces__msg__MotionReadyEnum__NOT_READY_NOT_REMOTE_STR";
    case MOTION_NOT_READY_SERVO_OFF: return "motoros2_interfaces__msg__MotionReadyEnum__NOT_READY_SERVO_OFF_STR";
    case MOTION_NOT_READY_HOLD: return "motoros2_interfaces__msg__MotionReadyEnum__NOT_READY_HOLD_STR";
    ...
    case MOTION_NOT_READY_PFL_ACTIVE: return "motoros2_interfaces__msg__MotionReadyEnum__NOT_READY_PFL_ACTIVE_STR";
...
void motoRosAssert_withMsg(BOOL mustBeTrue, ALARM_ASSERTION_FAIL_SUBCODE subCodeIfFalse, char* msgFmtIfFalse, ...)
{
    ...
    bzero(msg, STR_VAR_SIZE);

    va_start(va, msgFmtIfFalse);
    vsnprintf(msg, STR_VAR_SIZE, msgFmtIfFalse, va);
    va_end(va);
    ...
    FOREVER
    {
        printf("motoRosAssert: %s (subcode: %d)", msg, subCodeIfFalse);
        Ros_Sleep(5000);
    }
}
